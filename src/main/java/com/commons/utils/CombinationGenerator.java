...
public class CombinationGenerator<T> implements Iterable<List<T>>
{
                                ...
                                int combinationLength)
    {
        ...
        BigInteger sizeFactorial = MathUtil.bigFactorial(elements.length);
        BigInteger lengthFactorial = MathUtil.bigFactorial(combinationLength);
        BigInteger differenceFactorial = MathUtil.bigFactorial(elements.length - combinationLength);
